  ...
  return (
    <div className="flex flex-col min-h-[760px] bg-white overflow-hidden">
      ...
      <div className="bg-white flex items-center justify-between px-5 py-3.5 flex-shrink-0 border-b border-slate-100">
        ...
        <p className="font-display text-[16px] font-extrabold text-slate-700 tracking-wide">Daftar Akun</p>
        <div className="w-7 h-7" />
      </div>

      <div className="flex-1 overflow-y-auto px-6 pt-6 pb-8 flex flex-col gap-4">
        <p className="text-[14px] font-semibold text-slate-500">Buat akun untuk menyimpan data vaksin kucingmu.</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[12px] font-bold text-slate-500">atau isi form</span>
          <div className="flex-1 h-px bg-slate-100" />
        </div>
        ...
        {/* Confirm password */}
        <div className="flex flex-col gap-1.5">
          <label className="text-[12px] font-semibold text-slate-500">Konfirmasi Password</label>
          <div className="relative">
            <Input
              ...
              className={confirm && confirm !== password ? 'border-rose-400 pr-11' : 'pr-11'}
            />
            <button
              type="button"
          ...
          {confirm && confirm !== password && (
            <p className="text-[12px] font-semibold text-rose-500">Password tidak cocok</p>
          )}
        </div>
        ...
        <p className="text-[12px] font-semibold text-slate-500 leading-relaxed">
          ...
          <span className="text-slate-700 font-bold">Syarat & Ketentuan</span> dan{' '}
        ...
        <p className="text-center text-[14px] font-semibold text-slate-500">
          Sudah punya akun?{' '}
          <button onClick={() => navigate('login')} className="font-extrabold text-slate-700 active:opacity-70">
            Masuk
          </button>
        </p>
      </div>
